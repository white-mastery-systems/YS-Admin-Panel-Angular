export const environment = {
  ...
  config_data: {
    ...
    live_pricing_store_id: "667be4d64ad50b7759af6b20", // set client store _id to show Live Pricing in Store Settings
    ...
    catalog_pages: ["5d30013a5c83a702392c4c8b", "688db84d709f9742eb76814c"], // store ids allowed to see Catalog Pages (admin only)
